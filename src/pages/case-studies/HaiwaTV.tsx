    ...
    <div className="bg-black">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <ScrollReveal delay={0.2} width="100%">
          <p className="text-xl md:text-3xl text-white/60 max-w-3xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <ScrollReveal delay={0.1}>
            <div>
              ...
              <div className="text-sm md:text-base text-white/50 uppercase tracking-widest font-semibold">TVs Sold</div>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.2}>
            <div>
              ...
              <div className="text-sm md:text-base text-white/50 uppercase tracking-widest font-semibold">Enquiries</div>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.3}>
            <div>
              ...
              <div className="text-sm md:text-base text-white/50 uppercase tracking-widest font-semibold">New Followers</div>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.4}>
            <div>
              ...
              <div className="text-sm md:text-base text-white/50 uppercase tracking-widest font-semibold">Reach</div>
            </div>
          </ScrollReveal>
        </div>
      </section>
      ...
      <section ref={targetRef} className="relative h-[300vh]">
        <div className="sticky top-0 h-screen flex flex-col justify-center overflow-hidden border-t border-white/5">
          <div className="px-4 sm:px-6 lg:px-8 max-w-7xl w-full mx-auto mb-12">
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight">The 90-Day Growth Story</h2>
          </div>
          ...
          <motion.div style={{ x }} className="flex gap-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-max">
            ...
            <div className="w-[85vw] md:w-[600px] shrink-0">
              <GlassCard className="h-full min-h-[400px] flex flex-col justify-center relative overflow-hidden">
                <div className="absolute top-0 right-0 text-[120px] font-bold text-white/5 leading-none -mt-4 -mr-4">01</div>
            ...
            {/* Month 2 */}
            <div className="w-[85vw] md:w-[600px] shrink-0">
              <GlassCard className="h-full min-h-[400px] flex flex-col justify-center relative overflow-hidden border-white/20">
                <div className="absolute top-0 right-0 text-[120px] font-bold text-white/5 leading-none -mt-4 -mr-4">02</div>
            ...
            {/* Month 3 */}
            <div className="w-[85vw] md:w-[600px] shrink-0">
              <GlassCard className="h-full min-h-[400px] flex flex-col justify-center relative overflow-hidden border-brand-blue/30">
                <div className="absolute top-0 right-0 text-[120px] font-bold text-white/5 leading-none -mt-4 -mr-4">03</div>
      ...
      {/* Bottom CTA */}
      <section className="py-32 px-4 text-center border-t border-white/5 bg-white/[0.02]">
        <ScrollReveal width="100%">
          <h2 className="text-3xl md:text-5xl font-bold mb-8">Ready for similar results?</h2>
          <a
            href="/contact"
